...
public class EchoServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         // Get null if the parameter is missing from query string.
         if (gender == null) {
            out.println("<p>Neme: Hiányzik</p>");
         } else if (gender.equals("m")) {
            out.println("<p>Neme: Férfi</p>");
         } else {
         ...
         if (instruction == null
            ...
            out.println("<p>Bemutatkozás: Nincs</p>");
         } else {
            out.println("<p>Bemutatkozás: " + instruction + "</p>");
         }
         ...
         out.println("<p>A Kiválasztott Paraméterek: ");
